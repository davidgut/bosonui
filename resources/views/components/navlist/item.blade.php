{{--
@description Navlist item. Set icon="name" for leading icon, badge="count" for badge. Pass badge:variant, badge:size, badge:color for badge customization. Auto-detects current page from href, or set current explicitly. Use turbo:* prefix for Turbo attributes (e.g. turbo:frame, turbo:action).
...
@php
    ...
    $itemAttrs = Boson::except($attributes, ['badge', 'turbo']);
