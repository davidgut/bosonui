 ...
 * Data attribute names used by BosonForm
 */
...
export const ERROR_SELECTOR = '[data-boson-error]';

// Success behavior opt-outs
export const NO_RESET_ATTR = 'data-no-reset-on-success';
export const NO_CLOSE_ATTR = 'data-no-close-on-success';
